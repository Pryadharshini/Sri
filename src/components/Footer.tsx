      ...
      <div className="w-full max-w-[1400px] mx-auto px-8 flex flex-col items-center">
        ...
        <div className="mb-12 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-1 text-white/70 font-sans text-sm text-center">
            ...
            <a
              href="https://maps.app.goo.gl/MgpZb4bLEZxsM81u5"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 text-sm font-medium text-white/90 underline underline-offset-4 hover:text-white"
            >
              View our shop on Google Maps
            </a>
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-16">
          <Link
            href="/bharathanatyam"
            className="text-xs uppercase tracking-[0.1em] font-sans font-bold text-white/90 hover:text-white transition-colors"
          >
            Bharathanatyam
          </Link>
          <Link
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center border-t border-white/10 pt-8">
          ...
          <div className="flex gap-6">
            <a
              href="https://www.instagram.com/sri_sanjana_tailoring/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-sans text-white/80 hover:text-white transition-colors font-bold"
            >
              Instagram
            </a>
            <Link
              href="https://www.facebook.com/vaishumurali2731/"
              className="text-xs font-sans text-white/80 hover:text-white transition-colors font-bold"
            >
              Facebook
            </Link>
